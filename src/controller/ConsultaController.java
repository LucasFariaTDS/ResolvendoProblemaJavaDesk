...
public class ConsultaController {
    ...
    public void agendarConsulta() {
        ...
        if (consultaDAO.salvarConsulta(consulta)) {
            ...
            System.out.println("❌ Falha ao agendar a sua consulta.");
        }
    }
    ...
    private int solicitarIdade() {
        while (true) {
            ...
            try {
                ...
                System.out.println("Idade inválida. Digite entre 1 e 115.");
            } catch (NumberFormatException e) {
                System.out.println("Digite um número que sejá válido.");
            }
        }
    }
    ...
    public void listarMedicos() {
        List<Medico> medicos = medicoDAO.listarMedicos();
        if (medicos.isEmpty()) {
            System.out.println("Não há nenhum medico cadastrado no momento.");
            return;
        }
        System.out.println("\n Médicos cadastrados:");
